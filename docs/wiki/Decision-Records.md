...
- **Consequence:** Supported changes can be made without editing the full rule,
  and unsupported tokens remain preserved in the raw value during structured edits.